...
## Stochastic Gradient Descent 
 ...
 Stochastic Gradient Descent (SGD) is a machine learning model that uses stochastic optimization to find the optimal parameters for a given machine learning model.
